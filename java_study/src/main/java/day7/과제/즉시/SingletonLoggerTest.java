...
public class SingletonLoggerTest {
    public static void main(String[] args) throws Exception {
        // 첫 번째 로거 인스턴스 가져오기
         SingletonImmediateInitialization logger1 = SingletonImmediateInitialization.getInstance();
         logger1.initialize("application_dcl.log", SingletonImmediateInitialization.LogLevel.INFO);

        // 두 번째 로거 인스턴스 가져오기
        SingletonImmediateInitialization logger2 = SingletonImmediateInitialization.getInstance();
        ...
        // 로그 레벨 변경 후 테스트
        System.out.println("\n로그 레벨 변경 테스트:");
        logger1.setMinLogLevel(SingletonImmediateInitialization.LogLevel.DEBUG);
        ...
        SingletonImmediateInitialization  logger3 = SingletonImmediateInitialization.getInstance();
